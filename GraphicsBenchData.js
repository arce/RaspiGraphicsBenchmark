function setup() {
	...
	data = data.concat(localStorage.getItem("GraphicsBenchCircle-100"));
	data = data.concat(localStorage.getItem("GraphicsBenchCircle-500"));
	data = data.concat(localStorage.getItem("GraphicsBenchCircle-1000"));
	data = data.concat(localStorage.getItem("GraphicsBenchCircle-5000"));
    data = data.concat(localStorage.getItem("GraphicsBenchCircle-10000"));
	data = data.concat(localStorage.getItem("GraphicsBenchCircle-50000"));
	data = data.concat(localStorage.getItem("GraphicsBenchCircle-100000"));
	data = data.concat(localStorage.getItem("GraphicsBenchCircle-500000"));
	...
	data = data.concat(localStorage.getItem("GraphicsBenchFillCircle-100"));
	data = data.concat(localStorage.getItem("GraphicsBenchFillCircle-500"));
	data = data.concat(localStorage.getItem("GraphicsBenchFillCircle-1000"));
	data = data.concat(localStorage.getItem("GraphicsBenchFillCircle-5000"));
    data = data.concat(localStorage.getItem("GraphicsBenchFillCircle-10000"));
	data = data.concat(localStorage.getItem("GraphicsBenchFillCircle-50000"));
	data = data.concat(localStorage.getItem("GraphicsBenchFillCircle-100000"));
	data = data.concat(localStorage.getItem("GraphicsBenchFillCircle-500000"));
